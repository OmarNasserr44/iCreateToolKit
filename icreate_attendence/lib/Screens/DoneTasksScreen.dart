          ...
          children: [
            ...
            Center(
              child: SizedBox(
                ...
                child: CustText(
                    text: "All Done Tasks", fontSize: screenSize.width / 9),
              ),
            ),
            SizedBox(
              ...
              child: Obx(
                () => ListView(
                  children: Get.find<DoneTasksHistory>().doneCards.isNotEmpty
                      ? Get.find<DoneTasksHistory>().doneCards
                      : [
                          Column(
                            children: [
                              const SizedBox(
                              ...
                              CustText(
                                  text: "No Done Tasks Today", fontSize: 20),
                            ],
                          )
                        ],
                ),
